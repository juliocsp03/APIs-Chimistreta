...
# conn = psycopg2.connect(database="prueba", host="alpha.tamps.cinvestav.mx", user="postgres", password="example", port="5441")
conn = psycopg2.connect(database="prueba", host="localhost", user="postgres", password="example", port="5441")
